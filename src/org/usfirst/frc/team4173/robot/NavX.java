...
//	}
	...
	public double convertTo180Angles(double angle) {
		...
		double angle360 = angle - Math.floor(angle/360) * 360;
	...
	/**
	 * @return Returns the heading of the robot. Its heading can be anything from -180 to +180 degrees
	 */
	public double getHeading() {
		double rawHeading = navX.getAngle();
		double relativeAngle = getRelativeAngle(rawHeading);
		double finalAngle = convertTo180Angles(relativeAngle);
		return finalAngle;
	}
	...
	/**
	 * @return Returns the current roll value (in degrees, from -180 to 180) reported by the sensor. Roll is a measure of rotation around the X Axis.
	...
	/**
	 * Sets the current angle of the robot as its origin or 0
	 */
